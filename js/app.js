(() => {
    ...
    let formValidate = {
        ...
        addError(formRequiredItem) {
            ...
            if (forms.length) for (const form of forms) if (form.querySelector("._button-form")) form.querySelector("._button-form").setAttribute("disabled", "");
    ...
    function initSliders() {
        if (window.matchMedia("(max-width: 991.98px)").matches) if (document.querySelector(".services__body")) new core(".services__body", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.2,
